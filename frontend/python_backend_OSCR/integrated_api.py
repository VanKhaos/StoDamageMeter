"""
Vollständig integrierte OSCR-API für WPF-Integration
Verwendet echte OSCR-Funktionalität ohne externe Abhängigkeiten
"""
...
try:
    ...
    import main as oscr_main
    import datamodels as oscr_datamodels
    import combat as oscr_combat
    import detection as oscr_detection
    import iofunc as oscr_iofunc
    import parser as oscr_parser
    import utilities as oscr_utilities
    import constants as oscr_constants
    import oscr_read_file_backwards as oscr_read_file_backwards
    
    OSCR = oscr_main.OSCR
    OverviewTableRow = oscr_datamodels.OverviewTableRow
    Combat = oscr_datamodels.Combat
    CritterMeta = oscr_datamodels.CritterMeta
