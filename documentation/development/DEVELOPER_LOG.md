...
- `frontend/Windows/App/App.xaml.cs` - Startup auf LandingWindow geändert
- `frontend/frontend.csproj` - ApplicationDefinition hinzugefügt
...
**Datum:** 2025-10-11  
**Dauer:** ~1 Stunde  
**Fokus:** Implementierung von Log-Rotation für Backend und Frontend, Verhinderung von unbegrenztem Log-Wachstum
...
- ✅ Frontend kompiliert mit Log-Rotation
