"""
Standalone API-Wrapper für WPF-Integration
Funktioniert sowohl als Modul als auch als eigenständige Executable
"""
...
try:
    ...
    # Pfad zu den eingebetteten Modulen
