"""
Vollständig integrierte OSCR-API mit echter OSCR-Funktionalität
Verwendet echte OSCR-Daten ohne Mock-Fallback
"""
...
try:
    # Versuche relative Imports zuerst
    ...
    try:
        ...
        logger.error("This is a critical error - OSCR functionality will not work.")
        OSCR_AVAILABLE = False
        sys.exit(1)  # Beende das Programm, da OSCR nicht verfügbar ist
